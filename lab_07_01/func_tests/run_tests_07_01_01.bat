...
echo NEGATIVES
echo neg_01_test
app.exe func_tests\\file_in.txt
if errorlevel -1 ( echo PASSED!) else ( echo Failed!)
pause
echo neg_02_test
app.exe func_tests\\file_in.txt func_tests\\file_out.txt f toomuch
if errorlevel -1 ( echo PASSED!) else ( echo Failed!)
pause
echo neg_03_test
app.exe func_tests\\file_in.txt func_tests\\file_out.txt F
if errorlevel -1 ( echo PASSED!) else ( echo Failed!)
pause
echo neg_04_test
app.exe func_tests\\does_not_exist.txt func_tests\\file_out.txt
