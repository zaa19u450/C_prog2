...
и год выхода на экран.

В названии кинофильма не более двадцати пяти символов.

В фамилии кинорежиссёра не более двадцати пяти символов.

Год выхода задаётся целым числом.
...
- 04 - при поиске по title введена слишком длинная строка;
- 05 - при поиске по name введена слишком длинная строка;
...
- 10 - файл пустой;
- 11 - слишком длинное title;
- 12 - слишком длинное name;
...
- 17 - в файле слишком много записей;
...
- 15 - проверка длины строк name и title на границе